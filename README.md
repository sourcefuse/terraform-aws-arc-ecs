...
| [aws_iam_policy_attachment.ec2_role_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy_attachment) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_additional_launch_template_policy_arns"></a> [additional\_launch\_template\_policy\_arns](#input\_additional\_launch\_template\_policy\_arns) | List of additional IAM policy ARNs to attach to the IAM role | `list(string)` | `[]` | no |
