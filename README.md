...
|------|-------------|------|---------|:--------:|
| <a name="input_alb_name"></a> [alb\_name](#input\_alb\_name) | Name of the Application Load Balancer | `string` | `"my-application-load-balancer"` | no |
...
| <a name="input_lb"></a> [lb](#input\_lb) | ALB-related information (listening port, deletion protection, security group) | <pre>object({<br>    name                 = string<br>    listener_port        = number<br>    deregistration_delay = optional(number)<br>    security_group_id    = list(string)<br>  })</pre> | n/a | yes |
